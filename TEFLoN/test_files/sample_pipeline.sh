...
cat ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.annotatedTE.fa | seqkit -w 70 sort > ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.annotatedTE.sorted.fa
cat ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.mappingRef.fa | seqkit -w 70 sort > ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.mappingRef.sorted.fa
rm ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.annotatedTE.fa ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.mappingRef.fa
mv ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.annotatedTE.sorted.fa ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.annotatedTE.fa
mv ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.mappingRef.sorted.fa ${WD}reference/${PREFIX}.prep_MP/${PREFIX}.mappingRef.fa
